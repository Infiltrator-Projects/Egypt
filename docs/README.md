...
This directory is the canonical documentation entry point for Egypt. The Infiltrator project family uses the same baseline document roles in every repository so readers can move between projects without relearning the structure.
...
- docs/GAME_DESIGN.md — specialist or historical detail retained alongside the canonical baseline.
- docs/DESIGN_DECISIONS.md — specialist or historical detail retained alongside the canonical baseline.
- docs/TECHNICAL_DECISIONS.md — specialist or historical detail retained alongside the canonical baseline.
- docs/PHARAOH_REFERENCE.md — specialist or historical detail retained alongside the canonical baseline.
- docs/PHARAOH_FORENSIC_REFERENCE.md — specialist or historical detail retained alongside the canonical baseline.
- docs/GRAPHICAL_SCREEN_ARCHITECTURE.md — specialist or historical detail retained alongside the canonical baseline.
- docs/VIEWPORT_PRESENTATION.md — specialist or historical detail retained alongside the canonical baseline.
- docs/WILDLIFE_SIMULATION.md — specialist or historical detail retained alongside the canonical baseline.
